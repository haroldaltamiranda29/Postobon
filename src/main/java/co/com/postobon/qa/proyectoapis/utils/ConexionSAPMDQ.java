...
public class ConexionSAPMDQ {
    static String   IP= "10.1.108.107", //IP or HOST
            USER="CE_RCARO", // user name of SAP
            PASSWORD="Noviembre2021*", // password of SAP
    ...
    private static void Conect() {
        ...
        try {
            ...
            destination = JCoDestinationManager.getDestination("MDQ");
            destination.ping();
...
/*
    ...
    static int Consultar(String strTabla, String strCampo, String strCondicion)
    {
        Conect();
        int numRows=0;
        try {
